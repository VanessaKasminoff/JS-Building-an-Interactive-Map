//Note: You do NOT need to create an external JS file for this project despite any instructions you may see in Canvas.
//This file, app.js, is the only external JS file you need.

// Create map
// Add openstreetmap tiles
const map = L.map('map').setView([48.868672, 2.34213], 12);
...
//Note: Replace 'https://.tile.openstreetmap.org///.png' with 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'
//in this copy/paste part in the Canvas activity instructions

// Create and add a geolocation marker
const marker = L.marker([48.87007, 2.346453]);
marker.addTo(map).bindPopup("<p><b>The Hoxton, Paris</b></p>");
...
const polygon = L.polygon(latLngs, {fillColor: 'transparent'}).addTo(map);
